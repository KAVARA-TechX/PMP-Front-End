      ...
      <Box bg="#082032" color="#fff">
        ...
        >
          <Box display={"flex"} flexDir="column">
            ...
            <Box display={"flex"} alignItems="flex-start" gap="5px" mt="10px">
            ...
            <Box display={"flex"} alignItems="flex-start" gap="5px" mt="10px">
              ...
              <Box position="relative" bottom="5px">
                <Text fontSize={"14px"}>
                  4th Floor, Plaza Mall, MG Road, Gurgaon, Haryana, 122002,
                  India
                </Text>
              </Box>
            </Box>
            ...
            <Box flexGrow={1}></Box>
            <Text pt="40px" display={{ base: "none", lg: "inline-block" }}>
              © Plan My Leisure 2017
            </Text>
          </Box>
          ...
          <Box pt="30px">
            ...
            <Box display={"flex"} flexDir="column" gap="5px" mt="8px">
              <Text
                cursor={"pointer"}
                onClick={() => {
                  navigate("/about-us");
        ...
        <Box px={{ base: "40px", lg: "9vw" }}>
          <Text py="20px" textAlign={"center"} display={{ lg: "none" }}>
